#A quantidade de peças que deveriam existir no quebra cabeças
...
#For loop que vai remover da lista completa todos os valores existentes na lista incompleta
